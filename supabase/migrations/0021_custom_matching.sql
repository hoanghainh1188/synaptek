-- 0021 (loại câu): cho phép loại 'matching' (nối cặp) ở custom_questions.
...
alter table public.custom_questions
  ...
  check (type in ('mcq','numeric','fraction','true-false','expression','fill-blank','multi','ordering','matching'));
